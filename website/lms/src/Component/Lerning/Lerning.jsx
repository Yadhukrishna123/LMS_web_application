...
const Lerning = () => {
  ...
  const getCourse = async () => {
    try {
      ...
      let quizSubmitRes = await axios.get("http://localhost:8080/api/v1/get_all_userSubmited_answer")
  ...
  const getLesson = async () => {
    try {
      const res = await axios.get(`http://localhost:8080/api/v1/get_lesson/${id}`)
      const getAllQres = await axios.get("http://localhost:8080/api/v1/get_all_module_quizz")
      console.log(res)
