...
const Detailpage = () => {
  ...
  const getCourseDetails = async () => {
    try {
      ...
      let getAllFeedbacks = await axios.get(`${import.meta.env.VITE_API_URL}/get_all_feedback`)
      setFeedbacks(getAllFeedbacks.data.feedbacks)


      let checkEnrollment = await axios.post(`${import.meta.env.VITE_API_URL}/check_enrollment`, {
  ...
  const handleFeedback = async (courseId) => {
    ...
    try {
      ...
      let res = await axios.post(`${import.meta.env.VITE_API_URL}/send_feedback`, payload)
