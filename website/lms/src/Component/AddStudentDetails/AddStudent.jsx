...
const AddStudent = ({ setShowForm, emailll, editMode, editStudent }) => {
    ...
    const getAllUsers = async () => {
        try {
            setLoading(true)
            let res = await axios.get("https://lms-web-application-backend-e6yj.onrender.com/api/v1/get_all_user")
            console.log(res)
    ...
    useEffect(() => {
        ...
        axios
            .get("https://lms-web-application-backend-e6yj.onrender.com/api/v1/get_all_batches")
