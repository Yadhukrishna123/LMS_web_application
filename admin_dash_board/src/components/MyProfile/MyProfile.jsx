    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4">
            ...
            <div className="flex justify-between items-center max-w-4xl mx-auto mb-6">
                ...
                {profile === "" ? (<Link to="/create_profile">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-gray-600">
                                    ...
                                    <li>
                                        <span className="font-medium">Student Strength:</span> {p.students}
                                    </li>
                                    <li>
                                        <span className="font-medium">Placement Rate:</span> {p.placement}
                                    </li>
                                    <li>
                                        <span className="font-medium">Facilities:</span> {p.accreditation}
                                    </li>
                                </ul>
                            </div>
                        </div>
