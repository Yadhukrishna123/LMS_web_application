...
const ScheduleBatch = () => {
    ...
    const fetchData = async () => {
      try {
        const [coursesRes, instructorsRes] = await Promise.all([
          axios.get("http://localhost:8080/api/v1/get_all_courses"),
          axios.get("http://localhost:8080/api/v1/view_instructor"),
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("http://localhost:8080/api/v1/create_batch", payload);
